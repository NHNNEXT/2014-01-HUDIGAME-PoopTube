...
bool Creature::Init()
{
	...
	mMesh2->SetAnimationTrack(2);
	AddChild(mMesh2);

	mMesh3 = pooptube::SkinnedMesh::Create(PATH_WOLF3);
	mMesh3->RotateFrontVectorY(3.14f);
	mMesh3->SetScale(2.f, 2.f, 2.f);
	mMesh3->SetAnimationTrack(1);
